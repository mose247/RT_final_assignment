...
'''
    ...
    of the same type to be published, eventually, on the /cmd_vel topic.
      Args:
...
def auto_vel_callback(msg):
    ...
    # Create a new Twist message and save in it the velocity published on /automatic/cmd_vel
    auto_vel= Twist()
    auto_vel= msg
...
def man_vel_callback(msg):
    ...
    # Create a new Twist message and save in it the velocity published on /manual/cmd_vel
    man_vel= Twist()
    man_vel= msg
...
'''
    Function that is used to get a goal position inside the map from the user.
      Args:
        - void
      Return:
