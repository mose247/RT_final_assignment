...
The command should launch both the files simulation_gmapping and move_base, plus the nodes teleop_twist_keyboard, user_interface and collision_avoidance. The last two of which have been developed for the assignment.
